...
class EnergySimulation:
    def __init__(
        ...
        daylight_savings_status: Iterable[int], indoor_drybulb_temperature: Iterable[float], average_unmet_cooling_setpoint_difference: Iterable[float], indoor_relative_humidity: Iterable[float], 
        ...
        self.indoor_drybulb_temperature = np.array(indoor_drybulb_temperature, dtype = float)
...
class Weather:
    def __init__(
        self, outdoor_drybulb_temperature: Iterable[float], outdoor_relative_humidity: Iterable[float], diffuse_solar_radiation: Iterable[float], direct_solar_radiation: Iterable[float], 
        outdoor_drybulb_temperature_predicted_6h: Iterable[float], outdoor_drybulb_temperature_predicted_12h: Iterable[float], outdoor_drybulb_temperature_predicted_24h: Iterable[float],
        ...
        self.outdoor_drybulb_temperature = np.array(outdoor_drybulb_temperature, dtype = float)
        ...
        self.outdoor_drybulb_temperature_predicted_6h = np.array(outdoor_drybulb_temperature_predicted_6h, dtype = float)
        self.outdoor_drybulb_temperature_predicted_12h = np.array(outdoor_drybulb_temperature_predicted_12h, dtype = float)
        self.outdoor_drybulb_temperature_predicted_24h = np.array(outdoor_drybulb_temperature_predicted_24h, dtype = float)
