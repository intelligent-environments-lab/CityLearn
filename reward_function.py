...
CityLearn returns the energy consumption of each building as a reward. This reward_function
takes all the electrical demands of all the buildings, computes a virtual electricity price which is
