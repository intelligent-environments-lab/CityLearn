...
def run(_run, _config, _log, pymongo_client):
    ...
    #unique_token = "{}__{}".format(args.name, args.seed)
    print(args.env_args["reward_style"])
    unique_token = "{}_reward{}_{}".format(args.name, args.env_args["reward_style"], args.seed)
