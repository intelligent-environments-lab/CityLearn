...
def set_grid():
    ...
    grid.loc[grid['agent_name']!='marlisa','--basic_rbc'] = True
    grid.loc[grid['agent_name'].isin(['basic_rbc','optimized_rbc']),'--exploration_period'] = 0
    grid.loc[grid['agent_name'].isin(['basic_rbc','optimized_rbc']),'--seed'] = 0
